...
namespace Labs
{
	...
	{	
		...
		private static void doMainMenu(DataModel dataModel)
		{
			printMainMenu();			
		...
		private static void doSubMenuCircle(DataModel dataModel)
		{
